...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="users-kategori.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-produk.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-keranjang.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-transaksi.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-pengguna.php">
