...
<head>
    ...
    <title>Produk - wartech Admin</title>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped mt-2">
                                ...
                                <tbody>
                                    ...
                                    $quary = isset($_GET['query']) ? mysqli_real_escape_string($koneksi, $_GET['query']) : '';

                                    // tambhkan where jika query tidak kosong
                                    ...
                                    if (!empty($quary)) {
                                        $sql_query .= " WHERE tb_produk.nm_produk LIKE '%$quary%' OR tb_kategori.nm_kategori LIKE '%$quary%' or tb_produk.desk LIKE '%$quary%'";
                                    }
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="e_produk.php?id=<?php echo $hasil['id_produk']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i>
                                                        <a href="h_produk.php?id=<?php echo $hasil['id_produk']; ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data?')"><i class="bi bi-trash"></i>
                                                        </a>
                                                </td>
                                            </tr>
                                        <?php
