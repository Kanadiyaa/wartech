...
<head>
    ...
    <title>Transaksi - wartech Admin</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        // Query untuk mengambil data penjualan dengan filter kategori
        $sql = "SELECT j.id_jual, u.username, j.tgl_jual, j.total, j.diskon 
        FROM tb_jual j 
        JOIN tb_user u ON j.id_user = u.id_user";

        if (!empty($kategori_filter)) {
            // Jika kategori dipilih, filter berdasarkan kategori yang terkait dengan produk
