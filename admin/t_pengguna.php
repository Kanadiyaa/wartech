...
if (isset($_POST['simpan'])) {
    ...
    //menghasilkan id baru dengan format U0001, U0002, dst
    ...
    if ($query) {
        echo "<script>alert('Data Berhasil Disimpan'); window.location='pengguna.php';</script>";
        header("refresh:0; pengguna.php");
    } else {
        echo "<script>alert('Data Gagal Disimpan'); window.location='pengguna.php';</script>";
        header("refresh:0; pengguna.php");
    }
}
?>
...
<head>
    ...
    <title>Tambah Pengguna -wartech Admin</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="t_pengguna.php">Beranda</a></li>
